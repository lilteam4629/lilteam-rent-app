...
const defaults = () => ({ users: [], walletTransactions: [], topups: [], usedSlipRefs: [], payment: {
  slipProvider: 'none', easyslipApiKey: '', slipokBranchId: '', slipokApiKey: '', slipcheckApiKey: '',
  slipcheckEndpoint: '', rdcwClientId: '', rdcwClientSecret: '', rdcwEndpoint: '', slip2goApiKey: '', slip2goEndpoint: '',
  promptpayId: '', promptpayName: '', bankName: '', bankAccountNumber: '', bankAccountName: '', truemoneyEnabled: false, truemoneyPhone: ''
} });
