...
module.exports = {
  ...
  updateRentalFeatures: (data) => request({ method: 'post', url: '/admin/rentals/features', data }),
  createFeatureRelease: (data) => request({ method: 'post', url: '/admin/rentals/releases', data }),
  deployFeatureRelease: (data) => request({ method: 'post', url: '/admin/rentals/releases/deploy', data }),
  ensureSystemLab: () => request({ method: 'post', url: '/admin/system-lab' }),
  ...
  verifyCaptcha: (token, remoteip) => request({ method: 'post', url: '/captcha/verify', data: { token, remoteip } }),
  plans: cachedPlans,
